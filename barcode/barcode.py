"""
Mask R-CNN
Train on the barcode dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 barcode.py train --dataset=/path/to/barcode/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 barcode.py train --dataset=/path/to/barcode/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 barcode.py train --dataset=/path/to/barcode/dataset --weights=imagenet
